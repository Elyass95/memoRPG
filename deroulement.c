...
int position(int *x, int *y,char **tableau) {
  ...
  if (*x == 2 && *y == 0 || (*(tableau[(*x)] + (*y)-1 ) != ('#') && *(tableau[(*x)-1] + *y) != ('#') && *(tableau[(*x)+1] + *y ) != ('#') )){
    do {
      printf("\n\n");
    ...
    else if( *(tableau[*x] + (*y)+1) != ('#') && *(tableau[(*x)] + (*y)-1 ) != ('#')){
      do {
      printf("\n");
      printf("        [1] high \n\n");
      printf("\n\n");
  ...
  else if (*x == 0 && *y == 4 || (*(tableau[(*x)] + (*y)-1 ) != ('#') && *(tableau[(*x)-1] + *y) != ('#') && *(tableau[(*x)+1] + *y ) != ('#'))) {
    do {
      printf("\n\n");
      printf("          ** where do you want to go ? **");
      printf("\n");
  ...
  } else if (*x == 4 & *y == 6 || (*(tableau[(*x)+1] + *y ) != ('#') && *(tableau[*x] + (*y)+1) != ('#') && *(tableau[(*x)-1] + *y) != ('#'))) {
    do {
      printf("\n\n");
      printf("          ** Where do you want to go ? **");
      printf("\n");
  ...
  } else if (*x == 6 && *y == 2 || (*(tableau[(*x)+1] + *y ) != ('#') && *(tableau[*x] + (*y)+1) != ('#') && *(tableau[(*x)] + (*y)-1 ) != ('#') )) {
    do {
      printf("\n\n");
      printf("          ** Where do you want to go ? **");
      printf("\n");
    ...
    if (*y == 5 ||(*(tableau[*x] + (*y)+1) != ('#') && *(tableau[(*x)-1] + *y) != ('#'))) {
      do{
      printf("\n\n");
      printf("          ** Where do you want to go ? **");
      printf("\n");
    ...
    if (*y == 5 || *(tableau[(*x)+1] + *y ) != ('#') && *(tableau[*x] + (*y)+1) != ('#')) {
      do{
      printf("\n\n");
      printf("          ** Where do you want to go ? **");
      printf("\n");
